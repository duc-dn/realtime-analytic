...
if __name__ == "__main__":
  ...
  while True:
    ...
    sql = "INSERT INTO orders (user_id, payment) value (%s, %s)"
    val = (random.randint(0, 10000), fake.payment_type())
    ...
    try:
      sql = "INSERT INTO order_detail (order_id, product_id, quantity, price, create_at) VALUES (%s, %s, %s, %s, %s)"
